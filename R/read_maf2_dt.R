...
#' @param groupby. If one patient have mutliple samples, this groupby is used to summarize them. 
...
read.maf = function(maf, groupby = NULL, removeSilent = TRUE, useAll = TRUE, gisticAllLesionsFile = NULL, gisticAmpGenesFile = NULL,
